...
```{r example, fig.height=7, fig.cap="ReEDS-2.0 regions."}
# library(usensys)
library(ReEDS)
library(sf)
library(ggplot2)
...
```{r, fig.height=7, fig.cap="ReEDS-2.0 existing transmission routes and endpoints."}
ggplot() +
...
```{r, fig.height=7, fig.cap="ReEDS-2.0 new transmission routes"}
ggplot() +
